...
- **Automated multi-repository release tool & local dev hot-reload compose** (`scripts/release.sh`, `docker-compose.dev.yml`): Added automated release script validating repository cleanliness and version synchronization across all 3 repos, alongside `docker-compose.dev.yml` for zero-build hot-reloading in local development.
