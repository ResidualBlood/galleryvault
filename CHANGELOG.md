...
- **Phase 3 start (perf)**: simple virtual render for cards via CSS content-visibility:auto (leverages browser IntersectionObserver for offscreen skip) + extended IO infinite (startInfinite) to favorites fav-items grid. smoke. commits f6f6b4a, fe3e11b. See PLAN.
