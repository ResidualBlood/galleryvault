...
window.GV_LOCALES.zh = {
  ...
  cookieExpiredNotice: "ExHentai Cookie 已失效，自动同步已暂停。", cookieNoAccessNotice: "当前账号无 ExHentai 里站访问权限，自动同步已暂停。", cookieHealthFailed: "ExHentai 探活失败（网络或站点异常），不一定是 Cookie 失效。", cookieNotConfiguredNotice: "未配置 ExHentai Cookie，无法进行在线同步与下载。", goToSettings: "前往设置",
  username: "用户名",
