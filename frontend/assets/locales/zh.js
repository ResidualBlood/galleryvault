...
window.GV_LOCALES.zh = {
  ...
  cookieExpiredNotice: "ExHentai Cookie 已失效，自动同步已暂停。", cookieNoAccessNotice: "当前账号无 ExHentai 里站访问权限，自动同步已暂停。", cookieIpBannedNotice: "当前 IP 被 ExHentai 封禁或暂时限制访问，自动同步已暂停。", cookieHealthFailed: "ExHentai 探活失败（网络或站点异常），不一定是 Cookie 失效。", cookieNotConfiguredNotice: "未配置 ExHentai Cookie，无法进行在线同步与下载。", goToSettings: "前往设置",
  username: "用户名",
  ...
  transUpdated: "翻译已更新",
  testTelegram: "发送测试消息",
  browse: "浏览", discover: "发现", library: "画廊库", series: "系列作品", tags: "标签", downloads: "下载",
  downloadsSub: "下载任务。",
  ...
  confirmClearHistory: "确定要清空所有阅读历史吗？此操作不可恢复。",
  historyCleared: "历史记录已清空",
  clearProgress: "清除阅读进度",
  ...
  archiveTitle: "冷库归档",
  archiveSub: "画廊冷存储归档任务管理。",
  archiveStart: "开始归档",
  archiveCancel: "取消归档",
  archiveRunning: "归档进行中…",
  archiveDone: "已归档",
  archiveSkip: "已跳过",
  archiveLogLabel: "冷库归档",
  archiveLogDesc: "正在归档画廊至冷存储",
  archiveFunds: "可用 GP", archiveTierOriginal: "原图", archiveTierResample: "重采样", archiveCost: "费用", archiveSize: "大小", archiveUnavailable: "GP 不足", archiveConfirm: "开始归档下载", archiveNoItems: "所选画廊没有可用的归档。", archivePreviewFail: "归档预览失败", archiveQueued: "已加入归档下载", archiveUnsupported: "部分所选画廊已本地或缺少 token，已跳过。",
  ...
  dlDefaultQuality: "默认画质",
  dlAddSubmit: "加入逐页",
  dlAddArchive: "归档下载",
  dlAddEmpty: "请输入至少一条有效的画廊链接或 gid/token",
  dlQueuedCount: "已入队 {count} 本",
  dlSkippedCount: "已在队列/跳过 {count} 本",
  dlFailedCount: "失败 {count} 本",
  dlUpdatedCount: "已改下新版 {count} 本",
  dlGoneCount: "已删除/404 {count} 本",
  dlGone: "已删除或不存在（404）",
  dlOrig: "下载原图", dlOrigArchive: "归档形式下载原图",
  dlOrigQueued: "已加入原图下载", dlOrigArchiveQueued: "已加入原图归档下载",
  dlArchivedCold: "已归档冷库", dlArchivePending: "归档中", dlArchiveFail: "归档失败",
  ...
  retry: "重试", retrySelected: "重试所选", retryAll: "重试所有任务",
  retryAllConfirm: "确定要重试所有挂起或失败的任务吗？（取消退避等待并立即重试）",
  retryAllSuccess: "成功重试了 {count} 个任务",
  selectAll: "全选",
  deleteDl: "删除",
  clearSuccessDl: "清除全部成功",
  confirmClearSuccessDl: "确定清除所有成功的下载任务记录？不会删除已入库的画廊文件。",
  clearedSuccessDl: "已清除 {count} 条成功任务",
  clearSuccessDlLog: "清除成功下载任务",
  ...
  notifScanOk: "扫库完成", notifScanFail: "扫库失败", notifCookie: "Cookie 失效", notifCookieNoAccess: "无里站权限", notifCookieIpBanned: "IP 被封禁",
  notifArchiveStart: "开始归档", notifArchiveOk: "归档完成", notifArchiveFail: "归档失败",
  jumpToPage: "跳转页码", jumpToPageHint: "跳转到指定页（按 G 或 Enter）", pageNumber: "页码",
  continueReading: "继续阅读", viewAllHistory: "查看全部历史", markUnread: "标为未读", progressClearedSingle: "已重置该画廊的阅读进度",
  delete: "删除", deleteGallery: "删除画廊", deleteFiltered: "删除筛选结果",
  addToFavorites: "加入收藏", changeFavCategory: "更改收藏夹", favAddTitle: "加入 ExHentai 收藏夹", favAddConfirm: "确认加入",
  favAdded: "已加入收藏夹", favAddFail: "加入收藏夹失败",
  ...
  dupFavTitle: "收藏夹重复", dupFavSub: "同一作品不同版本（DL/无修正/语言搬运）。",
  dupXgidTitle: "跨GID重复", dupXgidSub: "全库不同 gid（含未入库收藏云端）、标题判定为同一作品。可取消收藏、忽略；删除已下载需确认。",
  dupXgidHint: "尚未计算。请先扫描库，或点「重新计算」。", dupXgidNone: "未发现跨GID重复。",
  dupXgidRefresh: "刷新", dupXgidRecompute: "重新计算", dupXgidNoFav: "所选没有收藏项。",
  ...
  recycleRedownload: "按 gid 重下", recycleRedownloadSkip: "跳过",
  repair: "修复",
  ...
  deleteGalleryLog: "删除画廊", favoritesRemoveLog: "取消收藏", favoritesMoveLog: "移动收藏", favoritesAddLog: "加入收藏",
  ...
  "tasks.duplicates": "查重扫描", "tasks.duplicatesDesc": "正在扫描收藏夹中重复的画廊",
  "tasks.galleryUpdates": "检查更新", "tasks.galleryUpdatesDesc": "正在检测画廊更新",
  "tasks.orphanThumbnailCleanup": "清理孤儿缩略图", "tasks.orphanThumbnailCleanupDesc": "定期清理无对应画廊的缩略图缓存",
  "tasks.thumbnailPeriodicSeed": "缩略图周期播种", "tasks.thumbnailPeriodicSeedDesc": "定期检查并补充缺少缩略图的画廊",
  "tasks.downloadRetrySweep": "下载失败重试巡检", "tasks.downloadRetrySweepDesc": "自动重新入队符合重试条件的失败下载任务",
  "tasks.cookieHealth": "Cookie 健康巡检", "tasks.cookieHealthDesc": "定期探活 E-Hentai 登录状态",
  "tasks.calibrateStorage": "存储容量校准", "tasks.calibrateStorageDesc": "校准下载与缓存目录实际磁盘占用",
  "tasks.purgeArchivedSources": "清理归档源目录", "tasks.purgeArchivedSourcesDesc": "扫描并清理已归档画廊的源目录残留文件",
  "tasks.integrity": "缺页体检", "tasks.integrityDesc": "正在校验文件完整性",
  scanDuplicates: "查重扫描", duplicatesDesc: "正在扫描收藏夹中重复的画廊",
  detectUpdates: "检查更新", updatesDesc: "正在检测画廊更新",
  ...
  tagFilterHint: "点击筛选", tagExcludeHint: "Shift+点击排除",
  gallery: "画廊", gid: "GID", status: "状态", noData: "暂无数据",
  discoverSub: "在 ExHentai 上搜索，一键下载或加入收藏。",
  discoverPlaceholder: "搜索 ExHentai…",
  discoverEmpty: "没有匹配的画廊。",
  discoverSadPanda: "无法访问里站（Sad Panda）。请检查 Cookie / igneous。",
  discoverChallenge: "站点正在反爬挑战，请稍后再试。列表不会当成无结果继续翻页。",
  discoverRateLimited: "限流（509），请稍后再试。",
  discoverError: "搜索失败。",
  discoverInLibrary: "已入库",
  discoverFavorited: "已收藏",
  discoverNotDownloaded: "未下载",
  discoverDownload: "下载",
  discoverBatchDl: "批量下载",
  discoverBatchFav: "批量收藏",
  discoverSearch: "搜索",
  discoverPopular: "热门",
  discoverWatched: "订阅",
  discoverToplist: "排行",
  ...
  applySearch: "应用",
  deleteSearch: "删除搜索",
  savedSearchName: "搜索名称",
  savedSearchLimit: "最多保存 30 条搜索",
  localRating: "本地星级",
  localNote: "本地笔记",
  localTags: "自定义标签",
  saveLocal: "保存本地标记",
  ...
  storageTitle: "磁盘用量",
  storageLibrary: "画廊库",
  storageCold: "归档 / Archive",
  storageDownloads: "下载目录",
  storageCache: "缓存",
  storageLargest: "体积最大的画廊",
  storageComputing: "计算中...",
  storageLastComputed: "上次计算",
  storageFree: "可用",
  purgeArchivedSourcesBtn: "清理已归档源目录残留文件",
  purgeSourcesConfirm: "确定要清理已归档画廊在下载/图库目录中的残留源文件吗？此操作不可逆。",
  purgeSourcesDone: "清理完成，已删除源目录数：",
  purgeSourcesStarted: "清理任务已在后台启动",
  archivePurgeSources: "清理历史残留",
  missing: "不存在",
  networkError: "网络连接失败，请检查网络或后端服务。",
  offlineNotice: "当前处于离线状态。",
  onlineNotice: "网络已恢复连接。",
  seriesTitle: "系列作品",
  seriesSub: "管理同作品的多画廊系列组。",
  seriesCreate: "新建系列",
  seriesRebuild: "重新整理系列",
  seriesRename: "重命名",
  seriesDelete: "删除系列",
  seriesAddItem: "添加画廊",
  seriesRemoveItem: "移出系列",
  seriesPromptName: "请输入系列名称：",
  seriesPromptNewName: "请输入新的系列名称：",
  seriesPromptGalleryIds: "请输入要添加的画廊 ID（多个用逗号分隔）：",
  seriesConfirmDelete: "确定要删除此系列吗？",
  seriesConfirmRemove: "确定要将此画廊从系列中移出吗？移出后重扫将不再自动加回。",
  seriesEmpty: "暂无系列作品，点击“重新整理系列”可自动扫描入组，或点击“新建系列”手工建组。",
  seriesRebuilt: "系列整理完成：新建 {created} 组，并入 {merged} 本画廊",
  seriesManual: "手动",
  seriesAuto: "自动",
  ...
  autoScroll: "自动滚动",
  logAutoScroll: "自动滚动",
  seriesInputGidsHint: "输入 gid（多个用逗号或空格分隔）：",
  promptAddSeriesGids: "输入 gid（多个用逗号或空格分隔）：",
  seriesCloudCandidates: "勾选未入组收藏：",
  selectUncategorizedFavs: "勾选未入组收藏：",
  searchFavorites: "搜索收藏夹...",
  searchFavs: "搜索收藏夹...",
  noCandidates: "无可选候选",
  seriesRemoveGidsHint: "输入要移出的作品 gid（多个用逗号或空格分隔）：",
  confirmRemoveSeriesItem: "确定移出",
  atLeastOneItem: "请至少输入或勾选一个作品",
  pagePerUnit: "/ 页",
  pageSizeAria: "每页条数",
  jumpPageAria: "跳转页码",
  jump: "跳转",
  ...
  legendAccount: "账户",
  legendInterface: "界面",
  legendSiteProxy: "站点与代理",
  legendLibrary: "资料库",
  legendDownloads: "下载",
  legendDownloadAdvanced: "下载高级",
  legendTags: "标签",
  legendThumbnails: "缩略图",
  legendNotifications: "通知 Telegram",
  thCategory: "类别",
  thPath: "路径",
  thItems: "项目数",
  thUsed: "已用空间",
  ...
  storageGalleries: "画廊",
  storageImages: "图片",
  storageThumbsApprox: "约 {count} 缩略图",
  storageGalleryCount: "{galleries} 画廊 / {images} 图片",
  dupXgidInfoSummary: "跨 GID 查重聚类打分机制与云端对比决策说明",
  ...
  integrityInfoSummary: "缺页坏图体检与魔数校验机制说明",
