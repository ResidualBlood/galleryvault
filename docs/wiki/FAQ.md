...
- **Magic Header 二进制校验**：系统以 2 并发深度检测落盘图片前 16 字节头部特征码（校验 JPEG `FF D8 FF`、PNG `89 50 4E 47`、GIF `47 49 46 38`、WebP `RIFF....WEBP` 魔数）与 4/8 位补零命名规范，可精准揪出传输截断残图、403/503 HTML 错误页伪装的坏图与错乱序列。
