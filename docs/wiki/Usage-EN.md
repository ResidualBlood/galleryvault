...
- **[Browsing & Library (Library)](Library-EN)**:
  ...
  - [Series (#/series)](Library-EN#series-series) — Doujinshi/Manga default filtering with pagination, event prefix stripping, score-based auto grouping, scan rebuild, and manual series curation.
