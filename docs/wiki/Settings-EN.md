...
- **7z / PDF scan**: library scan accepts `.7z` (py7zr, images only; per-page in-memory extract, 128MB cap) and `.pdf` (embedded images; skip images over 128MB; skip the gallery with a warning if none).
